...
\usepackage{array}
% % make horizontal align center in tabular
% \newcolumntype{P}[1]{>{\centering\arraybackslash}p{#1}}
% % make vertical align center in tabular
% \newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}
% make vertical align center and horizontal align left in tabular
...
\usepackage{titlesec}
\titleformat{\chapter}[display]{\bfseries\Large}{CHAPTER \centering\Roman{chapter}}{0ex}{\vspace{0ex}\centering}
