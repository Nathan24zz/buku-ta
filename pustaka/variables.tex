...
\newcommand{\tatitle}{IMITASI POSE TUBUH BAGIAN ATAS MANUSIA OLEH ROBOT \emph{HUMANOID} MENGGUNAKAN KESAMAAN KOSINUS}
\newcommand{\engtatitle}{\emph{UPPER BODY HUMAN POSE MIMICKING BY HUMANOID ROBOT USING COSINE SIMILARITY FUNCTION}}
