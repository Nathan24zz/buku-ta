...
Therefore they use OKS loss, they extend the idea of  IOU loss from box to keypoints. OKS is treated as IOU in case of keypoints. OKS is computed for each keypoint separately and then summed to give the final OKS loss or keypoint IOU loss \parencite{maji2022yolopose}.
\begin{equation}
...
The overall loss for Keypoint RCNN is a sum of loss for class prediction, bounding box,
keypoints, and keypoints confidence with its threshold as seen in Equation 3.2
