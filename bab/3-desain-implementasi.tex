...
Our main program uses websites to interact with users because of its flexibility on any platform. So there is a Javascript client and a Python Server that communicate via \emph{socketio}.
